...
#endif
#include "Examples.h"
enum ConsoleColor : unsigned int { // 0000 IRGB
...
void MenuExamples() {
  ...
  cout << "    1.  Приклад переводу цілого числа з десяткової системи в "
          "двійкову \n";
  cout << "    2.  Приклад обчислення виразу використовуючи тiльки побiтовi "
          "операцiї. \n";
  ...
  cout << "    6.  Exit \n";
#else
  cout << "    1.  An example of converting an integer from the decimal system "
          "to binary \n";
  cout << "    2.  An example of calculating an expression using only bitwise "
          "operations. \n";
...
void Examples() { // Examples of tasks using bitwise operations
...
void Example2() {
  ...
  cout << " Введiть a  b ";
#else
  cout << "An example of calculating an expression using only bitwise "
          "operations.\n";
  cout << "Expression : x = 33 * a + (a * 16 – b * 17) / 8 + (15 * b + 300) / "
          "128. \n";
  cout << " Input a  b ";
#endif
